...
| --- | --- | --- | --- |
| `docs/par/0003-runbook-layer.md` | `<file>` | 20260802T210348Z | the runbook layer's design session — form, home, naming, and the derivation-and-test discipline — after which this record is rewritten to govern the settled system; open directions: SESSION-2026-08-02-runbook-gap.md |
