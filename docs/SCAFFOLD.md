...
- 📁 `experiments/`
  ...
  - 📁 `orchestrator-experiments/`
    ...
    - 📁 `results/`
      ...
      - 📄 `05-priority-under-contention-20260830T045052Z.json`
      - 📄 `05-priority-under-contention-20260830T045152Z.json`
      - 📄 `06-invalidation-20260830T044350Z.json`
      - 📄 `07-form-negotiation-20260830T044652Z.json`
    ...
    - 📄 `05-priority-under-contention.py` — Does ranking the queue protect the person, and what does it cost the sweep?
    - 📄 `06-invalidation.py` — When one branch of a diamond changes, what does the other branch pay?
