...
These are items that can be done at any point to improve the repo.

- Run /tighten on a file that needs it (found with the script)
- Evaluate architecture against prior art for missteps
