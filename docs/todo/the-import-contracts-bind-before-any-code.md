...
One placement v2 cannot answer: `mutual` gets no layer line until Phase 5
decides whether it ports. There is no `compat` layer — v2 projects do not
import (`adr/v2-does-not-import.md`).
