...
both CLIs run on the stirred clip (05.1), outputs compared at the product
...
`tests/goldens/`, minted by 02.4's mechanism and carrying the exact
...
single kernel matches — which 02.4 and the Phase 4 items already prove one at
