...
Qt-free by the same argument as `gui/transport/pacing.py`, which was the other
half of this file before the two packages were drawn: the mapping can be off by
...
is proportional — `frame / frame_count * width` — and not the groove-less-handle
